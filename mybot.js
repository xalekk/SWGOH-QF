...
client.on("message", async message => {
  ...
  if(command === "sithh") {
	...
	.addField("%0A**Toujours en mode avion.**","%0ATeam JTR,  4%+ peuvent enregistrer.%0APour plus d'infos :point_right:  <#437585712464789524>")
	//.addBlankField(true)
	.setAuthor(message.member.displayName, message.author.avatarURL)
	.setColor(0xa20410)
	...
	.addField("Tout le monde doit faire 2% minimum (1 million) durant cette phase.","%0APour la tactic de P2, vous pouvez consulter ici :point_right:  <#437594040435998740>")
	//.addBlankField(true)
	.setAuthor(message.member.displayName, message.author.avatarURL)
	.setColor(0xa20410)
